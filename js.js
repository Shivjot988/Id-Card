...
function ProductCard(product) {
    ...
    <header>
        <div class="container-Tital">
            <h1>ID Card Create</h1>
            <p>Design professional ID cards online</p>
        </div>
    </header>
    <div class="container">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="address-name-punjabi"
                                placeholder="Translated address name will appear here">
                        </div>
                    </div>
                                ...
                                <div class="card-back" aria-label="Card back">
                                    <div class="address-details">
                                        <p><span id="preview-address-label-en">Address :</span> <span
                                                id="preview-address-type">W/O</span> <span
                                                id="preview-address-name">John Doe</span></p>
